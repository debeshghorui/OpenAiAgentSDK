...
async function main(query = '') {
    try {
        let result = await run(sqlAgent, query, {
            conversationId: 'conv_695b520a41b88193ae8639742d0242d8072648adac6b6bb6',
        });
...
main("Write a query to get all employees with my name");
